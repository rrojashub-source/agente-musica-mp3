...
git remote add origin https://github.com/rrojashub-source/agente-musica-mp3.git

 git config --global user.email "rrojas.hub@gmail.com"
 git config --global user.name "rrojashub-source"
