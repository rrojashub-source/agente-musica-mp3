...
class TestMetadataTagger:
    ...
    def test_metadata_tagger_class_exists(self):
        ...
        if self.tagger_class is None:
            pytest.fail("MetadataTagger class not found - implement src/core/metadata_tagger.py")
    ...
    def test_metadata_tagger_has_musicbrainz_client(self):
        ...
        if self.tagger is None:
            pytest.fail("MetadataTagger not initialized")

        # Should have autocompleter instance (which has mb_client)
        assert hasattr(self.tagger, "autocompleter")
        assert self.tagger.autocompleter is not None
    ...
    def test_metadata_tagger_tag_file_method_exists(self):
        ...
        assert hasattr(self.tagger, "tag_file")
    ...
    def test_metadata_tagger_uses_autocompleter_for_lookup(self):
        ...
        assert hasattr(self.tagger, "lookup_and_tag")
