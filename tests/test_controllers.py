...
class TestPlaybackController:
    ...
    def test_on_global_next_library_mode(self, controller):
        ...
        controller.library_tab._on_next_clicked.assert_called_once()

    def test_on_global_next_playlist_mode(self, controller):
        """Test next routes to playlist in playlist mode"""
        controller._playback_source = 'playlist'
        controller._current_playlist_songs = [
            {'id': 1}, {'id': 2}, {'id': 3}
        ]
        controller._current_playlist_index = 0
        controller.db_manager.get_song_by_id.return_value = {
            'id': 2, 'title': 'Song 2', 'file_path': '/tmp/test.mp3'
        }
    ...
    def test_on_global_prev_library_mode(self, controller):
        ...
        controller.library_tab._on_prev_clicked.assert_called_once()
    ...
    def test_on_global_song_ended_library(self, controller):
        ...
        controller.library_tab._on_song_ended.assert_called_once()
...
class TestLibraryController:
    ...
    def test_on_album_selected(self, controller):
        ...
        controller.library_tab.search_input.setText.assert_called_once_with('Dark Side')
    ...
    def test_handle_focus_search(self, controller):
        ...
        controller.search_tab.search_input.setFocus.assert_called_once()
...
class TestUIComposerStructure:
    ...
    def test_ui_composer_has_dialog_methods(self):
        ...
        from controllers.ui_composer import UIComposer
        expected = [
            '_show_api_settings', '_show_equalizer', '_change_language',
            '_toggle_theme', '_show_about', '_show_api_guide',
...
class TestMainFacadeStructure:
    ...
    def test_main_module_imports(self):
        ...
        from controllers import PlaybackController, RemoteController, UIComposer, LibraryController
