...
class TestAudioPlayer(unittest.TestCase):
    ...
    def test_02_player_loads_file(self):
        ...
        with patch('os.path.exists', return_value=True):
            ...
            self.assertEqual(self.player._current_file, "/path/to/test.mp3")
    ...
    def test_04_player_pauses_audio(self):
        ...
        self.assertEqual(self.player._state, PlaybackState.PAUSED)
    ...
    def test_05_player_resumes_audio(self):
        ...
        self.assertEqual(self.player._state, PlaybackState.PLAYING)
    ...
    def test_08_player_gets_current_position(self):
        ...
        self.assertAlmostEqual(position, 30.5)
    ...
    def test_09_player_gets_duration(self):
        ...
        with patch('os.path.exists', return_value=True), \
             patch('mutagen.File') as MockFile:
    ...
    def test_10_player_sets_volume(self):
        ...
        self.assertEqual(self.mock_mpv_instance.volume, 75.0)
    ...
    def test_13_player_get_volume(self):
        ...
        self.assertAlmostEqual(volume, 0.5)

    def test_14_player_state_enum(self):
        """Test PlaybackState enum values"""
        from core.audio_player import PlaybackState
        self.assertEqual(PlaybackState.STOPPED.value, "stopped")
        self.assertEqual(PlaybackState.PLAYING.value, "playing")
        self.assertEqual(PlaybackState.PAUSED.value, "paused")
