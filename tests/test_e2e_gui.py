...
class TestLibraryTabE2E:
    ...
    def test_library_filter_method(self, library_tab):
        ...
        has_filter = (
            hasattr(library_tab, "filter_songs")
            or hasattr(library_tab, "_filter_library")
            or hasattr(library_tab, "apply_filter")
            or hasattr(library_tab, "refresh_library")
        )
...
class TestSearchTabE2E:
    ...
    def test_add_to_download_queue(self, search_tab):
        ...
        # Add selected song
        search_tab.selected_songs = [{"video_id": "test123", "title": "Test", "artist": "Artist"}]
...
class TestQueueWidgetE2E:
    ...
    def test_queue_displays_items(self, queue_widget):
        ...
        # Add item to queue
        item_id = queue.add(
            video_url="https://youtube.com/watch?v=test", metadata={"title": "Test Song", "artist": "Test Artist"}
        )
    ...
    def test_queue_pause_resume(self, queue_widget):
        ...
        # Add and start item
        item_id = queue.add(
            video_url="https://youtube.com/watch?v=test", metadata={"title": "Test", "artist": "Artist"}
        )
    ...
    def test_queue_clear_completed(self, queue_widget):
        ...
        # Add completed item
        item_id = queue.add(
            video_url="https://youtube.com/watch?v=test", metadata={"title": "Completed", "artist": "Artist"}
        )
        queue._items[item_id]["status"] = "completed"

        # Add pending item
        item_id2 = queue.add(
            video_url="https://youtube.com/watch?v=test2", metadata={"title": "Pending", "artist": "Artist"}
        )
...
class TestSmartPlaylistE2E:
    ...
    def test_save_and_load_playlists(self, playlist_engine, tmp_path):
        ...
        # Create playlist
        config = SmartPlaylistConfig(name="Test Playlist", rules=[PlaylistRule("genre", "equals", "Rock")])
